...
const styles = StyleSheet.create({
  ...
  muted: { color: "#94a3b8", textAlign: "center", fontSize: 14 },
  ...
  image: { width: 68, height: 68, borderRadius: 14, backgroundColor: "#0f172a" },
  imagePlaceholder: { alignItems: "center", justifyContent: "center" },
  imagePlaceholderText: { color: "#64748b", fontSize: 11, fontWeight: "600" },

  itemContent: { flex: 1, gap: 4 },
  itemTitle: { color: "#f8fafc", fontWeight: "800", fontSize: 16 },
  itemBrand: { color: "#94a3b8", fontSize: 13 },
